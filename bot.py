# -*- coding: utf-8 -*-
"""
ربات هوشمند تحلیل فیوچرز ارزهای دیجیتال - نسخه ۳.۵.۳
...
def format_signal_message(code: str, direction: str, plan: RiskPlan, setup_type: str, ai_status: str, ai_text: str, ind: IndicatorSnapshot, funding: Optional[float], oi: Optional[float], rate: float) -> str:
    ...
    text = (
        ...
        f"{rtl}📊 **وضعیت بازار**\n"
        f"{rtl}   • شاخص قدرت نسبی (RSI): `{ind.rsi:.1f}`\n"
        f"{rtl}   • قدرت روند (ADX): `{ind.adx:.1f}`\n"
        f"{rtl}   • نسبت حجم: `{ind.volume_ratio:.2f}x`\n"
