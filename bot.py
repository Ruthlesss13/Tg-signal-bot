...
def stats_summary() -> dict:
    ...
    for r in by_setup:
        ...
        setup_lines.append(f"• {_setup_label_fa(r['st'])}: کل {r['total']} | TP1 {r['tp1']} | سودده {r['wins']} | زیان {r['losses']} | نرخ {sw}")
