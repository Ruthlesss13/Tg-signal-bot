...
CCXT_REQUEST_CONCURRENCY = max(1, int(os.getenv("CCXT_REQUEST_CONCURRENCY", "4")))
...
async def periodic_scan(app: Application):
    ...
    logger.info(f"🛡️ Scan concurrency=4 | CCXT request concurrency={CCXT_REQUEST_CONCURRENCY} | HTTP pool=32")
