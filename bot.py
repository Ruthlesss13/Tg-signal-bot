...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "coins_prices_all":
        ...
        prices, rate = await asyncio.gather(cache.update_prices(), fetch_irt_rate())
...
async def periodic_scan(app: Application):
    ...
    logger.info(f"🛡️ Scan concurrency=4 | CCXT request concurrency={CCXT_REQUEST_CONCURRENCY}")
